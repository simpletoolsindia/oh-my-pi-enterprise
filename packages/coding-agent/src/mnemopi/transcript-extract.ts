 ...
 * shape. The retention pipeline ultimately receives a serialized transcript
...
import { hasSubstantiveContent, type TranscriptMessage } from "./transcript-content";
 ...
 */
export function extractMessages(sessionManager: ReadonlySessionManagerLike): TranscriptMessage[] {
